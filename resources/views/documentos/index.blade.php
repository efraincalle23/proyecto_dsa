            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="date" name="fecha_recepcion" class="form-control"
                        placeholder="Buscar por fecha_recepcion" value="{{ request('fecha_recepcion') }}">
                </div>
                <div class="col-md-4">
                ...
                @foreach ($documentos as $documento)
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Botón de respuesta -->
                            @if ($documento->origen === 'Recibido')
                                <!-- Ajusta la condición según tu lógica -->
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <select name="origen" id="origen" class="form-control">
                                                <option value="Emitido"
                                                    {{ old('origen', $documento->origen) == 'Emitido' ? 'selected' : '' }}>
                                                    Emitido</option>
                                                <option value="Recibido"
                                                    {{ old('origen', $documento->origen) == 'Recibido' ? 'selected' : '' }}>
                                                    Recibido</option>
                                            </select>
                                            @error('origen')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="fecha_editar"
                                                name="fecha_recepcion" value="{{ $documento->fecha_recepcion }}"
                                                required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="documento_padre_id" id="documento_padre_id"
                                                class="form-select">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="historialModalLabel{{ $documento->id_documento }}">
                                        ...
                                        <strong>{{ $documento->tipo }}
                                            N°
                                            {{ $documento->numero_oficio }} -2024-VRACAD</strong>
                    ...
                    <div class="modal fade" id="respuestaModal{{ $documento->id_documento }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <form action="{{ route('documentos.storeRespuesta', $documento->id_documento) }}"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="origen">Origen</label>
                                <select name="origen" id="origen" class="form-control">
                                    <option value="Emitido" {{ old('origen') == 'Emitido' ? 'selected' : '' }}>Emitido
                                    </option>
                                    <option value="Recibido" {{ old('origen') == 'Recibido' ? 'selected' : '' }}>Recibido
                                    </option>
                                </select>
                                @error('origen')
                                    <div class="alert alert-danger">{{ $message }}</div>
