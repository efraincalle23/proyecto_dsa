            ...
            <form method="GET" action="{{ route('documentos_emitidos.index') }}" class="mb-4">
                <div class="row">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('documentos_emitidos.index') }}" class="btn btn-outline-secondary">
...
@else
{{ $ultimoHistorial->estado_nuevo ?? 'S/A' }} por 
                                {{ $ultimoHistorial->usuario->apellido }}
                        ...
                        <td>
                            ...
                            @if ($documento->eliminado)
                                <form action="{{ route('documentos_emitidos.restore', $documento->id) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('PUT')
                    ...
                    <div class="modal fade" id="respuestaModal-{{ $documento->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form action="{{ route('documentos_recibidos.storeRespuestaRecibida', $documento->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                    ...
                    <div class="modal fade" id="editModal-{{ $documento->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form action="{{ route('documentos_emitidos.update', $documento->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-header">
                    ...
                    <div class="modal fade" id="deleteModal-{{ $documento->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg"">
                            <div class="modal-content">
                                <form action="{{ route('documentos_emitidos.destroy', $documento->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <div class="modal-header">
                            ...
                            <form method="POST" action="{{ route('historial.asignarEmitidos', $documento->id) }}">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="numero_oficio">Número de Oficio</label>
                                            <input type="text" name="numero_oficio" id="numero_oficio"
                                                class="form-control" value="{{ $documento->numero_oficio }}" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Remitente</label>
                                            <input type="text" class="form-control" value="{{ $documento->destino }}"
                                                disabled>
                                        </div>
                                        <div class="mb-3">
