...
@section('content')
    ...
    {{-- Filtros de búsqueda --}}
    <form method="GET" action="{{ route('documentos.emitidos') }}" class="mb-4">
        <div class="row">
            <div class="col-md-4">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <a href="{{ route('documentos.emitidos') }}" class="btn btn-outline-secondary">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="historialModalLabel{{ $documento->id_documento }}">Historial
                                    del Documento <strong>{{ $documento->tipo }} N°
                                        {{ $documento->numero_oficio }}-2024-VRACAD</strong></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Cerrar"></button>
                            </div>
                            <div class="modal-body">
    ...
    <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('documentos.storeEmitido') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createModalLabel">Crear Documento Emitido</h5>
